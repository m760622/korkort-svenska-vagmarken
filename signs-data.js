...
const SIGNS = [
  ...
  { id:'A1-1', category:'varning', nameSv:'Varning för farlig kurva (höger)', nameAr:'تحذير من منعطف خطير (يمين)', descSv:'Märket varnar för en farlig högerkurva.', descAr:'تحذر من وجود منعطف حاد لليمين.',
    svg: '<img src="assets/signs/all/A1.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A1-2', category:'varning', nameSv:'Varning för farlig kurva (vänster)', nameAr:'تحذير من منعطف خطير (يسار)', descSv:'Varnar för en farlig vänsterkurva.', descAr:'منعطف خطير ناحية اليسار.',
    svg: '<img src="assets/signs/all/A1.png" style="width:100%; height:100%; object-fit:contain; transform: scaleX(-1);" />' },
  { id:'A2', category:'varning', nameSv:'Varning för flera farliga kurvor', nameAr:'تحذير من عدة منعطفات خطيرة', descSv:'Varnar för minst två farliga kurvor.', descAr:'تحذير من عدة منعطفات خطيرة متتالية.',
  ...
  { id:'A4', category:'varning', nameSv:'Varning för stigning', nameAr:'تحذير من منحدر صاعد', descSv:'Varnar för en brant stigning.', descAr:'الطريق يرتفع بشكل حاد.',
    svg: '<img src="assets/signs/all/A4.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A5', category:'varning', nameSv:'Varning för avsmalnande väg', nameAr:'تحذير من ضيق الطريق', descSv:'Vägbanan blir smalare framöver.', descAr:'يضيق الطريق من الجانبين.',
    svg: '<img src="assets/signs/all/A5.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A6', category:'varning', nameSv:'Varning för bro', nameAr:'تحذير من جسر متحرك', descSv:'Varnar för en öppningsbar bro.', descAr:'تحذير من جسر متحرك.',
  ...
  { id:'A9', category:'varning', nameSv:'Varning för farthinder', nameAr:'تحذير من مطب صناعي', descSv:'Varnar för ett farthinder.', descAr:'وجود مطب صناعي على الطريق.',
    svg: '<img src="assets/signs/all/A9.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A10', category:'varning', nameSv:'Varning för slirig väg', nameAr:'تحذير من طريق زلق', descSv:'Vägen kan vara hal.', descAr:'الطريق قد يكون زلقاً.',
    svg: '<img src="assets/signs/all/A10.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A11', category:'varning', nameSv:'Varning för stenskott', nameAr:'تحذير من تطاير الحصى', descSv:'Risk att löst grus eller småsten slungas upp.', descAr:'خطر تطاير أحجار صغيرة.',
    svg: '<img src="assets/signs/all/A11.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A12', category:'varning', nameSv:'Varning för stenras', nameAr:'تحذير من انهيار صخري', descSv:'Risk för fallande stenar.', descAr:'سقوط صخور من الجبل.',
  ...
  { id:'A17', category:'varning', nameSv:'Varning för skidåkare', nameAr:'تحذير من متزلجين', descSv:'Risk för skidåkare på eller vid vägen.', descAr:'تحذير من متزلجين يعبرون الطريق.',
    svg: '<img src="assets/signs/all/A17.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A18', category:'varning', nameSv:'Varning för ridande', nameAr:'تحذير من فرسان', descSv:'Ridande kan finnas på eller vid vägen.', descAr:'وجود ركاب خيل على الطريق.',
    svg: '<img src="assets/signs/all/A18.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A19-1', category:'varning', nameSv:'Varning för djur (älg)', nameAr:'تحذير من حيوانات (موظ)', descSv:'Risk för älg som kan korsa vägen.', descAr:'خطر عبور حيوان الموز.',
  ...
  { id:'A19-2', category:'varning', nameSv:'Varning för djur (ren)', nameAr:'تحذير من حيوانات (الرنة)', descSv:'Risk för ren.', descAr:'خطر وجود الرنة.',
    svg: '<img src="assets/signs/all/A19.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A20', category:'varning', nameSv:'Varning för vägarbete', nameAr:'تحذير من أعمال طريق', descSv:'Pågående vägarbete framöver.', descAr:'وجود أعمال طريق.',
  ...
  { id:'A22', category:'varning', nameSv:'Varning för flerfärgssignal', nameAr:'تحذير من إشارة مرور', descSv:'Trafikljus reglerar trafiken längre fram.', descAr:'إشارة مرور ضوئية قادمة.',
  ...
  { id:'A24', category:'varning', nameSv:'Varning för sidvind', nameAr:'تحذير من رياح جانبية', descSv:'Stark sidvind kan påverka fordonet.', descAr:'رياح جانبية قوية.',
    svg: '<img src="assets/signs/all/A24.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A25', category:'varning', nameSv:'Varning för mötande trafik', nameAr:'تحذير من حركة مرور قادمة', descSv:'Mötande trafik kan förekomma.', descAr:'مرور قادم من الجهة المقابلة.',
    svg: '<img src="assets/signs/all/A25.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A26', category:'varning', nameSv:'Varning för tunnel', nameAr:'تحذير من نفق', descSv:'En tunnel finns framåt.', descAr:'نفق قادم.',
    svg: '<img src="assets/signs/all/A26.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A27', category:'varning', nameSv:'Varning för svag vägkant eller hög körbanekant', nameAr:'تحذير من حافة طريق خطرة', descSv:'Vägkanten är ostadig eller brant.', descAr:'حافة الطريق غير مستقرة.',
    svg: '<img src="assets/signs/all/A27.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A28', category:'varning', nameSv:'Varning för vägkorsning', nameAr:'تحذير من تقاطع', descSv:'Vägkorsning där högerregeln gäller.', descAr:'تقاطع طرق (أولوية لليمين).',
    svg: '<img src="assets/signs/all/A28.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A29', category:'varning', nameSv:'Varning för vägkorsning där trafikanter på anslutande väg har väjningsplikt eller stopplikt', nameAr:'تقاطع: المركبات الجانبية ملزمة بإفساح الطريق', descSv:'Trafik från sidogator har väjningsplikt.', descAr:'القادمون من الطرق الجانبية يفسحون الطريق.',
    svg: '<img src="assets/signs/all/A29.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A30', category:'varning', nameSv:'Varning för cirkulationsplats', nameAr:'تحذير من دوار', descSv:'En rondell finns framåt.', descAr:'دوار قادم.',
    svg: '<img src="assets/signs/all/A30.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A31', category:'varning', nameSv:'Varning för långsamtgående fordon', nameAr:'تحذير من مركبات بطيئة', descSv:'Långsamtgående fordon kan förekomma.', descAr:'مركبات تسير ببطء.',
  ...
  { id:'A33', category:'varning', nameSv:'Varning för terrängskotertrafik', nameAr:'تحذير من زلاقات جليدية', descSv:'Terrängskotrar kan korsa vägen.', descAr:'تحذير من عبور عربات الثلج.',
    svg: '<img src="assets/signs/all/A33.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A34', category:'varning', nameSv:'Varning för kö', nameAr:'تحذير من ازدحام مروري', descSv:'Risk för köbildning.', descAr:'احتمال ازدحام.',
    svg: '<img src="assets/signs/all/A34.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A35', category:'varning', nameSv:'Varning för järnvägskorsning med bommar', nameAr:'تحذير من تقاطع سكة حديد ببوابات', descSv:'Järnvägskorsning utrustad med bommar.', descAr:'تقاطع سكة حديد مزود بحواجز.',
    svg: '<img src="assets/signs/all/A35.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A36', category:'varning', nameSv:'Varning för järnvägskorsning utan bommar', nameAr:'تحذير من تقاطع سكة حديد بدون بوابات', descSv:'Järnvägskorsning utan bommar.', descAr:'تقاطع سكة حديد بدون حواجز.',
    svg: '<img src="assets/signs/all/A36.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A37', category:'varning', nameSv:'Varning för korsning med spårväg utan bommar', nameAr:'تحذير من تقاطع ترام', descSv:'Spårvagn kan korsa vägen.', descAr:'ترام قد يقطع الطريق.',
    svg: '<img src="assets/signs/all/A37.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A38', category:'varning', nameSv:'Avstånd till plankorsning', nameAr:'علامات مسافة لتقاطع سكة حديدية', descSv:'Visar avståndet till järnvägskorsningen.', descAr:'توضح المسافة المتبقية لمعبر السكة الحديدية.',
  ...
  { id:'A40', category:'varning', nameSv:'Varning för annan fara', nameAr:'تحذير من خطر آخر', descSv:'Annan fara än de som anges av andra varningsmärken.', descAr:'خطر آخر غير مذكور بعلامة محددة.',
    svg: '<img src="assets/signs/all/A40.png" style="width:100%; height:100%; object-fit:contain;" />' },
  { id:'A41', category:'varning', nameSv:'Varning för olycka', nameAr:'تحذير من حادث', descSv:'En olycka har inträffat framåt.', descAr:'حادث وقع أمامك.',
  ...
  { id:'E7', category:'anvisning', nameSv:'Gågata', nameAr:'شارع للمشاة', descSv:'Anger en gata avsedd för gående. Fordon får endast föras i gångfart och har väjningsplikt.', descAr:'تشير إلى شارع مخصص للمشاة. يُسمح بقيادة المركبات بسرعة المشي فقط مع إعطاء الأولوية للمشاة.',
  ...
  { id:'E14', category:'anvisning', nameSv:'Återvändsväg', nameAr:'طريق غير نافذ', descSv:'Anger en väg som är stängd i ena änden och inte medger genomfartstrafik.', descAr:'تشير إلى طريق مغلق من إحدى نهايتيه ولا يسمح بالمرور للجهة الأخرى.',
  ...
  { id:'G2', category:'gangcykel', nameSv:'Cykelled', nameAr:'مسار دراجات مسمى', descSv:'Anger en särskilt markerad led för cykeltrafik, ofta över längre sträckor.', descAr:'تشير إلى مسار محدد خصيصاً لحركة الدراجات الهوائية، وغالباً ما يمتد لمسافات طويلة.',
