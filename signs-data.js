...
const SIGNS = [
  ...
  // 15) OTHER (X)
  { id:'X1', category:'andra', nameSv:'Markeringspil', nameAr:'سهم توجيه', descSv:'Anger tvär kurva.', descAr:'تستخدم لتوجيه السائق في المنعطفات الحادة الخطيرة.', svg: IMG('assets/signs/X1.png') },
  { id:'X2', category:'andra', nameSv:'Markeringsskärm för hinder', nameAr:'لوحة تحديد العوائق', descSv:'Markerar hinder.', descAr:'لوحة توضع لتحديد العوائق على الطريق وتوجيه السير حولها.', svg: IMG('assets/signs/X2.png') },
  { id:'X3', category:'andra', nameSv:'Markeringsskärm för sidohinder', nameAr:'لوحة تحديد العوائق الجانبية', descSv:'Markerar sidohinder.', descAr:'لوحة تحدد العوائق الجانبية وتنبيه السائق لمكانها.', svg: IMG('assets/signs/X3.png') },
